...
////////////////////////////////////////////////////////////SET WAYPOINTS ON RVIZ////////////////////////////////
    ...
    if (test_route_array != nullptr){
        ...
        std::cout << "***********************************" << std::endl;
        std::cout << "********** Route selected *********" << std::endl;
        std::cout << "***********************************" << std::endl;

        default_way_points.resize(test_route_array->data[0]/2, 2);

        unsigned int ii=0;
        for (unsigned int i = 1; i <= test_route_array->data[0]; i+=2)
        {
            default_way_points.row(ii).col(0) << test_route_array->data[i];
            default_way_points.row(ii).col(1) << test_route_array->data[i+1];
            ii++;
        }
